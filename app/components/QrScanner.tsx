// app/components/QrScanner.tsx (簡化版本，移除 WebSocket)
    ...
    <div className="flex flex-col items-center space-y-2 w-full">
      ...
      {scannedData && (
        <div className="mt-4 p-6 bg-slate-700 rounded-lg shadow-inner w-full max-w-sm text-center">
          ...
          <div className="text-lg text-purple-300 break-all bg-slate-600 p-3 rounded-md mb-4">
                  ...
                  <div key={idx} className="text-sm">
                    {idx === 0 ? (
                      <div>
                        ...
                        <div className="font-mono text-xs mt-1">{line}</div>
                      </div>
                    ) : (
                      <div>
                        <span className="text-slate-400">時間:</span>
                        <div className="font-mono text-sm mt-1">{line}</div>
                      </div>
                    )}
                  </div>
                ))}
